            ...
            <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
              ...
              <div className="hidden md:flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-medium transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  style={{ fontFamily: "Cairo, sans-serif" }}
                  title={`تصدير ${filteredItems.length.toLocaleString()} نتيجة كـ Excel`}
                >
                ...
                <button
                  ...
                  disabled={loading || filteredItems.length === 0}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-xs font-medium transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  style={{ fontFamily: "Cairo, sans-serif" }}
                  title={`تصدير ${filteredItems.length.toLocaleString()} نتيجة كـ PDF`}
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
